...
a:hover, .useremail .name:hover, .useremail .postertrip:hover,
...
/* ===== CSS PROVIDED BY USER (4chan styles) ===== */
.anticon {
  display: inline-block;
  color: inherit;
  font-style: normal;
...
@media only screen and (max-width: 480px) {
    ...
    a, .useremail:not(:hover) .name:not(.capcode),
...
/* ===== ADDITIONAL 4CHAN STYLES (extensions, emotes, etc.) ===== */
...
/* Additional mobile styles (already included inside @media above) */
